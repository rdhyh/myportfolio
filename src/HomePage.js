...
import headerImage from './assets/images/geader.jpg'
  ...
  return (
    <div className="container">
      <header className="header" style={{ backgroundImage: `url(${headerImage})` }} >
        <h1 className='text1'>Welcome to My Portfolio Website</h1>
        <p>A simple introduction</p>
      </header>
      <Navbar />
      <main className="columns">
        <div className="column" id="about">
          <h2 className='text1'>Introduction</h2>
          <div className='acol'>
        ...
        <div className="column" id="experience">
          <h2 className='text1'>Experience</h2>
          <div className='acol'>
        <div className="column2" >
            <h2>Internship</h2>
        ...
        <div className="column" id="skills">
          <h2 className='text1'>Skills</h2>
          <div className='acolskills'>
        ...
        <div className="column" id="projects">
          ...
          <div className='acolskills'>
            <div className='column4' >
            <a href="https://github.com/rdhyh/demo" target="_blank" rel="noopener noreferrer">
